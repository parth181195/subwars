 ...
 * 
 * Usage:
 *   ts-node scripts/upload-to-bunny.ts
 * 
...
function uploadFileToBunny(
  ...
  return new Promise((resolve, reject) => {
    ...
    // Progress indicator
    let uploaded = 0;
    const totalChunks = Math.ceil(fileSize / 1024);
...
async function main() {
  try {
    ...
    const remotePath = 'voice-lines/voice-lines.json';
...
export { uploadFileToBunny, getBunnyConfig };
